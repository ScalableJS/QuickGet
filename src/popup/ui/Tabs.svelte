...
<div class="flex gap-1 border-0 border-b border-solid border-b-[var(--color-control-border)] mb-3" role="tablist" tabindex="-1" onkeydown={onKeydown}>
